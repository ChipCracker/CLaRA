...
The goal is a reproducible toolchain that checks LaTeX documents locally. The suite combines \emph{ChkTeX}, \emph{Vale}, \emph{toolchain}, and optional LLM-assisted hints.
...
This is an intentional typo dad
\end{document}